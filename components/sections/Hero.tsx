...
export function Hero({ lang, dict }: { lang: Locale; dict: Dictionary }) {
  ...
  return (
    <section className="relative flex min-h-[600px] w-full flex-col items-center overflow-hidden px-6 pt-[32px] pb-[52px] md:px-page lg:h-[631px] lg:min-h-0 lg:pt-[25px] lg:pb-0">
      ...
      <div className="relative flex w-full max-w-content flex-1 flex-col justify-center md:px-[25px]">
        <div className="flex w-full max-w-[600px] flex-col items-start gap-[22.9px]">
          ...
          >
            ...
            <Button href={`${base}/services`} variant="on-photo">
