...
export function Footer({ lang, dict }: { lang: Locale; dict: Dictionary }) {
  ...
  return (
    <footer className="mt-auto">
      {/* ── CTA banner ─────────────────────────────────────────────────── */}
      <section className="relative flex min-h-[520px] w-full flex-col justify-center overflow-hidden px-6 py-[100px] md:px-page">
        <Image
        ...
        <div className="relative mx-auto flex w-full max-w-content flex-col md:px-[25px]">
      ...
      <div className="bg-white pb-[25px] pt-[56px]">
        <div className="mx-auto flex w-full max-w-content flex-col gap-[58px] px-6 md:px-[25px]">
          <div className="flex flex-col gap-14 lg:flex-row lg:gap-[56px]">
            ...
            <div className="grid grid-cols-2 gap-x-[40px] gap-y-10 sm:grid-cols-[1fr_1fr_1.25fr] sm:gap-x-[32px] lg:flex-1">
              ...
              <FooterColumn heading={t.other}>
                <InfoRow icon={<MailIcon />} href={site.emailHref} label={site.email} />
                <InfoRow icon={<PhoneIcon />} href={site.phoneHref} label={site.phoneDisplay} />
...
function InfoRow({
  ...
  const body = (
    <span className="flex items-center gap-[6px]">
      ...
      <span className="min-w-0 text-[16px] font-medium leading-[24.8px] tracking-[-0.32px] text-[#5f5f5f] [overflow-wrap:anywhere]">
        {label}
      </span>
    </span>
  );
