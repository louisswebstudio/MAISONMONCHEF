  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/2] w-full overflow-hidden">
        ...
        />
        <span className="absolute start-[14px] top-[14px] inline-flex items-center gap-[6px] bg-warm-taupe px-[12px] py-[5px] text-[13px] font-medium leading-[20px] tracking-[-0.3px] text-white shadow-[0px_6px_16px_rgba(0,0,0,0.1)]">
