 ...
 * lib/site.ts — never inlined here — so the corrections logged against the
 * template leftovers (Rome address / Italian number / hello@aeron.com) can
 * never drift back in. Nav/Footer come from the locale layout, as on every
 * page.
 */
  ...
  return (
    <div className="pb-[96px] pt-[80px]">
      <Container className="flex flex-col gap-[80px]">
        ...
        <div className="flex flex-col items-start gap-[54px] lg:flex-row lg:items-center lg:gap-[70px]">
          {/* Left — intro + contact items */}
          <div className="flex w-full flex-col gap-[54px] lg:w-[585px] lg:shrink-0">
